...
func (s *Playlists) DeletePlaylistByRatingKey(ctx context.Context, request operations.DeletePlaylistByRatingKeyRequest, opts ...operations.Option) (*operations.DeletePlaylistByRatingKeyResponse, error) {
	globals := operations.DeletePlaylistByRatingKeyGlobals{
	...
	res := &operations.DeletePlaylistByRatingKeyResponse{
