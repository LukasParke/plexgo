...
<!-- UsageSnippet language="go" operationID="getWebsocketNotifications" method="get" path="/:/websockets/notifications" -->
```go
package main
...
func main() {
    ...
    res, err := s.Events.GetWebsocketNotifications(ctx, operations.GetWebsocketNotificationsRequest{})
    if err != nil {
        log.Fatal(err)
    }
    if res.Body != nil {
...
**[*operations.GetWebsocketNotificationsResponse](../../models/operations/getwebsocketnotificationsresponse.md), error**
