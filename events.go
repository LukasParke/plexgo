...
func (s *Events) GetWebsocketNotifications(ctx context.Context, request operations.GetWebsocketNotificationsRequest, opts ...operations.Option) (*operations.GetWebsocketNotificationsResponse, error) {
	globals := operations.GetWebsocketNotificationsGlobals{
		Accepts:          s.sdkConfiguration.Globals.Accepts,
		ClientIdentifier: s.sdkConfiguration.Globals.ClientIdentifier,
		Product:          s.sdkConfiguration.Globals.Product,
		Version:          s.sdkConfiguration.Globals.Version,
	...
	opURL, err := url.JoinPath(baseURL, "/:/websockets/notifications")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetWebsocketNotificationsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
