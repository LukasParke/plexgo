...
func (s *LiveTV) GetDVRRecordings(ctx context.Context, request operations.GetDVRRecordingsRequest, opts ...operations.Option) (*operations.GetDVRRecordingsResponse, error) {
	globals := operations.GetDVRRecordingsGlobals{
	...
	opURL, err := url.JoinPath(baseURL, "/livetv/recordings")
	if err != nil {
	...
	res := &operations.GetDVRRecordingsResponse{
...
//
// If set, this operation will use [Security.Token] from the global security.
func (s *LiveTV) GetDVRRecordingsByDVR(ctx context.Context, request operations.GetDVRRecordingsByDVRRequest, opts ...operations.Option) (*operations.GetDVRRecordingsByDVRResponse, error) {
	globals := operations.GetDVRRecordingsByDVRGlobals{
		Accepts:          s.sdkConfiguration.Globals.Accepts,
		ClientIdentifier: s.sdkConfiguration.Globals.ClientIdentifier,
		Product:          s.sdkConfiguration.Globals.Product,
		Version:          s.sdkConfiguration.Globals.Version,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/livetv/dvrs/{dvrId}/recordings", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetDVRRecordingsByDVRResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
//
// If set, this operation will use [Security.Token] from the global security.
func (s *LiveTV) DeleteLiveTVSession(ctx context.Context, request operations.DeleteLiveTVSessionRequest, opts ...operations.Option) (*operations.DeleteLiveTVSessionResponse, error) {
	globals := operations.DeleteLiveTVSessionGlobals{
		Accepts:          s.sdkConfiguration.Globals.Accepts,
		ClientIdentifier: s.sdkConfiguration.Globals.ClientIdentifier,
		Product:          s.sdkConfiguration.Globals.Product,
		Version:          s.sdkConfiguration.Globals.Version,
	...
	res := &operations.DeleteLiveTVSessionResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
